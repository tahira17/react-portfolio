  ...
  return (
    <div name="home" className="w-cover h-screen bg-hero_pattern bg-no-repeat">
      ...
      <div data-aos="zoom-in" className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-[#7162d0]">Hi, My name is</p>
        <h1 className="text-4xl sm:text-7xl font-bold text-[#7162d0]">
          Tahira Nawaz
        </h1>
        ...
        <div data-aos="zoom-in">
          <button className="text-white group border-2 px-6 py-3 my-2 flex items-center bg-[#7162d0]">
            {" "}
